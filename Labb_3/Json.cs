...
namespace Labb_3
{
    internal class Json
    {
        public async Task Save(QuestionPack questionPack, string fileName)
        {
            ...
            // Dialogruta? "Frågepaket sparat till fil."
        }

        // metod för att läsa in ETT QuestionPack från en JSON-fil.
        // Men jag vill ju läsa in HELA min LISTA med ALLA questionPacks!
